...
# image editing programs like Photoshop, Illustrator, or Inkscape.
...
# making the points red (color='red') and size=2
# 
...
# Hint: now use the `aes` function. The color argument can be used inside and outside the aesthetic 'aes()'
